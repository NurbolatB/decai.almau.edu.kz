const translations = {
    ru: {
      ...
      `,
        ...
        "speaker-4-name": "Кристоф Фенивеси",
        "speaker-4-desc": "Старший научный сотрудник отдела STEAM, Финский институт образовательных исследований, Университет Ювяскюля, Финляндия",
        ...
        "speaker-7-name": "Элис Шанти Касави",
        "speaker-7-desc": "Выдающийся ученый, работающий в Академии языковых исследований Технологического университета МАРА, Малайзия",
    ...
    `,
        ...
        "speaker-4-desc": "Senior Researcher of STEAM at the Finnish Institute for Educational Research, University of Jyväskylä, Finland",
        ...
        "speaker-7-name": "Alice Shanthi Kasawi",
        "speaker-7-desc": "Prolific researcher whose work positions her at the forefront of contemporary ESL pedagogy and digital learning",
    ...
    `,
      ...
      Маңызды мерзімдер:
        ...
        * Бағдарламаны жариялау: 2026 жылғы 1 наурыз
        ...
        "speaker-4-name": "Кристоф Фенивеси",
        "speaker-4-desc": "Ғылыми Қызметкер STEAM, Финляндиядағы Білім Беру Зерттеулері Финляндия Институты, Ювяскила Университеті",
        "speaker-5-name": "Эзза Мад Багури",
        ...
        "speaker-7-name": "Элис Шанти Касави",
        "speaker-7-desc": "Малайзияның МАРА Технологиялық Университетінің Тілдерді Зерттеу Академиясында жұмыс істейтін көрнекті ғалым",
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const speakerData = {
        ru: {
            ...
            2: {
                bio: "Андрей Комиссаров — Chief AI Officer корпорации «Синергия» и ведущий консультант по искусственному интеллекту в образовании Сбер Университета. Эксперт в области применения ИИ в образовательных технологиях, автор многочисленных публикаций и выступлений на международных конференциях.",
                report: "Тема доклада: «Практическое применение ИИ в образовании: опыт Сбер Университета». В докладе будут представлены реальные кейсы внедрения искусственного интеллекта в образовательные процессы."
            },
            3: {
            ...
            5: {
                bio: "Эзза Мад Багури — старший преподаватель Международного университета INTI, Малайзия. Специализируется на исследованиях в области образовательных технологий и методов преподавания. Имеет значительный опыт в разработке и внедрении цифровых инструментов обучения.",
        ...
        en: {
            ...
            2: {
                bio: "Andrey Komissarov is the Chief AI Officer at 'Synergy' Corporation and Leading AI Consultant in Education at Sber University. He is an expert in AI applications in educational technologies, author of numerous publications and presentations at international conferences.",
                report: "Report topic: 'Practical Application of AI in Education: Sber University Experience'. The report presents real cases of artificial intelligence implementation in educational processes."
            },
            3: {
            ...
            5: {
                bio: "Ezza Mad Baguri is a Senior Lecturer at INTI International University, Malaysia. She specializes in educational technology research and teaching methods. She has significant experience in developing and implementing digital learning tools.",
        ...
        kz: {
            ...
            2: {
                bio: "Андрей Комиссаров — «Синергия» корпорациясының Chief AI Officer-і және Сбер Университетінің білім берудегі жасанды интеллект бойынша жетекші кеңесшісі. Білім беру технологияларында ЖИ қолдану саласындағы сарапшы, көптеген жарияланымдар мен халықаралық конференциялардағы баяндамалар авторы.",
                report: "Баяндама тақырыбы: «Білім берудегі ЖИ-ны практикалық қолдану: Сбер Университет тәжірибесі». Баяндамада білім беру процестеріне жасанды интеллектті енгізудің нақты кейстері ұсынылған."
            },
            3: {
            ...
            5: {
                bio: "Эзза Мад Багури — Малайзиядағы INTI International University аға оқытушысы. Білім беру технологиялары мен оқыту әдістерін зерттеуде мамандандырылған. Цифрлық оқыту құралдарын әзірлеу және енгізуде елеулі тәжірибесі бар.",
